...
public class VideoPlayerFragment extends DialogFragment implements Player.EventListener {
    ...
    public VideoPlayerFragment(String path, Context context) {
        this.path = path;
...
//        dataSourceFactory = buildDataSourceFactoryFile(Uri.parse(path));
        ...
        MediaSource mediaSource = createLeafMediaSource(Uri.parse(path), "mp4");
